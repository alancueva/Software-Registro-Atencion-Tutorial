...
public class ima_profe_1 extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 10, 40, 30));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Vistas/Mensajes/Internship.gif"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ima_profe_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            ima_profe_1 dialog = new ima_profe_1(new javax.swing.JFrame(), true);
